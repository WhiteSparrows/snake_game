...
class Agent():
    ...
    def __init__(self):
        ...
        self.gamma = 0.9 #play with it but smaller than 1 discount rate
    ...
    def get_state(self, game):
        ...
        # np.array used for converting bool into 0/1
    ...
    def get_action(self, state):
        # random moves at beginning :  exploration
        # use epsilon in order to compute
        self.epsilon = 80 - self.nb_games #TODO : play with it
        final_move = [0, 0, 0]
